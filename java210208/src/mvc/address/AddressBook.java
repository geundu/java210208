...
public class AddressBook extends JFrame {
	...
	public void refreshData() throws Exception {
		...
		AddressCtrl		addressCtrl	= new AddressCtrl();
		AddressVO[]		aVOS		= addressCtrl.send();
		List<AddressVO>	list		= addressCtrl.sendAll();
	}
}
