...
import com.design.zipcode.LoginForm;

public class GeunduClient extends JFrame implements ActionListener {
...
//		nickname = JOptionPane.showInputDialog("닉네임을 입력하세요.");
	...
	public static void main(String[] args) {
		GeunduClient tc = new GeunduClient();
		tc.initDisplay();
		tc.init();
	}
