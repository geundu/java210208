...
public class JTableImage2 extends JFrame {
	...
	ImageIcon			imo1		= new ImageIcon(imgPath + "RYAN1.png");
	ImageIcon			imo2		= new ImageIcon(imgPath + "RYAN2.png");
	ImageIcon			imo3		= new ImageIcon(imgPath + "RYAN3.png");
	ImageIcon			imo4		= new ImageIcon(imgPath + "RYAN4.png");
	String[]			paths		= { imgPath + "RYAN1.png", imgPath + "RYAN2.png", imgPath + "RYAN3.png",
											imgPath + "RYAN4.png" };
	private Object[][]	str			= {
...
//     		ImageIcon originIcon = new ImageIcon(imgPath+"RYAN1.png");  
			...
			// image.setImage(new
			// ImageIcon(path+img).getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT));
